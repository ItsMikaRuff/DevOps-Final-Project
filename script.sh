...
#   קליטה של פרמטרים   #
        ...
        stage('Validate Input & Calculate Year of Birth') {
            steps {
                script {
                    ...
                    #    הסרת רווחים מיותרים מהשם ומהגיל    #
                    ...
                    if (!(name ==~ /^[A-Za-z\s]+$/)) {
                        ...
                        #    בדיקת גיל - חייב להכיל רק מספרים מעל 0 ומתחת ל150   #
    ...
    post {
        always {
            #  פרסום הקובץ ב-Jenkins HTML Publisher Plugin בקובץ שנקרא USER DATA OUTPUT   #
            publishHTML(target: [
                allowMissing: false,
